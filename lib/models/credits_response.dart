...
class CreditsResponse {
    ...
    int id;
    List<Participante> cast;
    List<Participante> crew;
    ...
    factory CreditsResponse.fromMap(Map<String, dynamic> json) => CreditsResponse(
        id: json["id"],
        cast: List<Participante>.from(json["cast"].map((x) => Participante.fromMap(x))),
        crew: List<Participante>.from(json["crew"].map((x) => Participante.fromMap(x))),
    );
...
get fullProfileImg{
  if(profilePath!=null) return 'https://image.tmdb.org/t/p/w500$profilePath';
    ...
    factory Participante.fromJson(String str) => Participante.fromMap(json.decode(str));
